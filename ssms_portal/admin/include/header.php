...
<head>
	...
	<!-- [Scripts] -->
	<!-- Jquery -->
	<script src="../../design/js/jquery/jquery-3.4.1.min.js"></script>
	...
	<script src="../../design/js/custom/accounting.min.js"></script>
<!--	<script src="../../design/js/custom/accounting.settings.js"></script>-->
...
<nav class="main-nav navbar navbar-expand navbar-dark bg-dark fixed-top shadow">
	...
	<div class="d-flex flex-grow-1 justify-content-center align-items-center" id="">
		<ul class="navbar-nav">
			<?php echo $main_nav; ?>
		</ul>
	</div>
	...
	<div class="d-flex flex-grow-1 justify-content-end align-items-center">
		<div class="d-flex flex-grow-1 justify-content-start w3-text-white"><?php echo $a_name_nav; ?></div>
		<ul class="navbar-nav">
			<li class="nav-item">
