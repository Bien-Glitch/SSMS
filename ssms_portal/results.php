	...
	<div id="body" class="container-fluid">
		...
		<div class="row">
			<div class="col-md-8 s-md-border-right p-1 display">
				<div id="result-info">
					<div class="alert alert-info">Select Class, Session, Term to view result</div>
				</div>
	...
	$(document).ready(function () {
		...
		function loadSchoolClassSessionsAndTerms() {
			...
			function classes() {
				...
				$.ajax({
					url: './admin/include/classes/manage.php',
					method: 'POST',
					data: {
						action: 'get-classes'
					},
			...
			result_form.submit(function (e) {
				e.preventDefault();
				let session_id = localStorage.getItem('session_id'),
					student_id = localStorage.getItem('log_student_id'),
					class_id = localStorage.getItem('class_id'),
					term_id = localStorage.getItem('term_id');
